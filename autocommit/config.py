...
models = {model["name"]:{"uuid":model["id"] ,"word_limit" :model["maxTokens"]["input"]} for model in response if model["cloud"] or model.get("downloaded",False)} # getting the models that are available in the cloud or is downloaded
